...
from custom_models_save.efficientnet_sp._efficientnet_blocks import *
...
class EfficientNetBuilder:
    ...
    def _make_block(self, ba, block_idx, block_count):
        ...
        ba['mid_chs'] = ba['mid_chs']
        ba['out_chs'] = ba['out_chs'] # self.round_chs_fn(ba['out_chs']) # change for sp
        s2d = ba.get('s2d', 0)
        if s2d > 0:
        ...
        if 'force_in_chs' in ba and ba['force_in_chs']:
            ...
            ba['force_in_chs'] = ba['force_in_chs'] # self.round_chs_fn(ba['force_in_chs']) # change for sp
