...
from custom_models_save.efficientnet_sp._efficientnet_blocks import SqueezeExcite
from custom_models_save.efficientnet_sp._efficientnet_builder import BlockArgs, EfficientNetBuilder, decode_arch_def, efficientnet_init_weights, \
...
def _gen_efficientnet_lite(variant, channel_multiplier=1.0, depth_multiplier=1.0, pretrained=False, blc_cfg=None, **kwargs):
    ...
    blc_cfg = decode_arch_def(arch_def, depth_multiplier, fix_first_last=True)
    print(blc_cfg)
...
@register_model
def efficientnet_lite3(pretrained=False, blc_cfg=None, **kwargs) -> EfficientNet:
    """ EfficientNet-Lite3 """
    # NOTE for train, drop_rate should be 0.3, drop_path_rate should be 0.2
    model = _gen_efficientnet_lite(
        'efficientnet_lite3', channel_multiplier=1.2, depth_multiplier=1.4, pretrained=pretrained, blc_cfg=blc_cfg, **kwargs)
    return model
